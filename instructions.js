...
instr_text[8] = "While you will have 1 or 2 pointers " + "<img class='inlineShape' src='img/hand_pointer.png' />" + ", the Player will have either 1 or 2 hammers " + "<img class='inlineShape' src='img/hammer.png' />" + ". <br>For example, in this image they possess 1 hammer.<br>" + "<img class='hamShape' src='img/hammer_ex.png' />" + "<br><br>The hammers represent the number of boxes " + "<img class='inlineShape' src='img/drkbrown_box.png' />" + " the Player " + "<img class='inlineShape' src='img/person.png' />" + " will be able to open in that round.<br><br>Remember: Just as you can choose to select 0, 1, or 2 boxes (up to 2 if you have 2 pointers), they may choose to open NONE of the boxes or not use all of their hammers.";
