...
instr_text[3] = "<b>You and your partner will be looking at two different screens.</b><br>On your screen, you will see 3 boxes " + "<img class='inlineShape' src='img/drkbrown_box.png' />" + " with either bananas " + "<img class='bananaShape' src='img/ai_banana.png' />" +  "or scorpions " + "<img class='scorpShape' src='img/ai_scorpion.png' />" +  "  located inside them. Meanwhile, the Player " + "<img class='inlineShape' src='img/person.png' />" +  " will be able to see the boxes, but not what is inside.<br><div class='outlineBlock'>YOUR perspective: " + "<img class='outlineShape' src='img/aihelper_ex.png' />" + "<div style='padding-left: 30px; display: inline-block'>Your PARTNER's perspective: " + " <img class='outlineShape' src='img/aipartner_ex.png' /></div></div>"; 
instr_text[4] = "There are points involved in these mazes, but <b>only the Player " + "<img class='inlineShape' src='img/person.png' />" +  " can collect these points</b> for you.<br><br>If the Player opens a box " + "<img class='inlineShape' src='img/drkbrown_box.png' />" + " with a banana " + "<img class='bananaShape' src='img/ai_banana.png' />" +  "inside, you will both <b>gain 10</b> points. <br>If they open a box " + "<img class='inlineShape' src='img/drkbrown_box.png' />" +  " with a scorpion " + "<img class='scorpShape' src='img/ai_scorpion.png' />" +  " inside, you will both <b>lose 30</b> points.<br>Additionally, for every step that the Player " + "<img class='inlineShape' src='img/person.png' />" +  " takes in the maze, you will both <b>lose 1</b> point. <br><br>Remember, <b>the Player " + "<img class='inlineShape' src='img/person.png' />" +  " does NOT know what is inside each box. Only you do.</b> Use your knowledge of the map to help the Player maximize both of your points." ;
instr_text[5] = "";

instr_text[6] = "How can you help? <b>You will be able to place tokens " + "<img class='inlineShape' src='img/silv_token4.png' />" +  " on the boxes " + "<img class='inlineShape' src='img/drkbrown_box.png' />" +  " on your partner’s screen.</b> <br><br>Each round you will be given either 1 or 2 tokens. You may use none, one, or all of your tokens. The Player will also know how many tokens you are given. <br>To place a token on a box, simply click on the desired box in the map. <br><br>In the example below, you possess 2 tokens, and have placed 1 on a box.<br>" + "<img class='outlineShapeHand' src='img/token_ex.png' />" + "<img class='outlineShapeLonely' src='img/aitokenmap_ex.png' />";
