...
instr_text[4] = "There are points involved in these mazes, but <b>only the Player can collect these points for you</b>.<br><br>If the Player " + "<img class='inlineShape' src='img/person.png' />" +  " opens a box " + "<img class='inlineShape' src='img/drkbrown_box.png' />" + " with a banana" + "<img class='bananaShape' src='img/banana.png' />" +  "inside, you will both <b>gain</b> points. If they open a box " + "<img class='inlineShape' src='img/drkbrown_box.png' />" +  " with a scorpion" + "<img class='inlineShape' src='img/pink_scorpion2.png' />" +  " inside, you will both <b>lose</b> points.<br>Additionally, you will both <b>lose</b> points for every step that the Player takes in the maze. <br><br>Remember, the Player " + "<img class='inlineShape' src='img/person.png' />" +  " does not know what is inside each box. Only you do. <b>Use your knowledge of the map to help the Player maximize both of your points.</b>" ;
instr_text[5] = "";
